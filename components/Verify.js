export default Verify = ({ token }) => {
    const [verified, setVerified] = useState(false);

    useEffect(async() => {
        var response = await get(`Auth/VerifyUser/${token}`, '')
    ...
    return (
        <div>
                  ...
                  <ul className="flex items-center hidden space-x-8 lg:flex">
                      ...
                      <div className="relative flex items-center justify-end">
                          <a href="#" className="block relative">
                              <img alt="profile" src="https://i.ibb.co/bvxhMZJ/png-clipart-united-states-avatar-organization-information-user-avatar-service-computer-wallpaper.png" className="mx-auto object-cover rounded-full h-10 w-10"/>
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            {verified ?<p tabIndex={0} role="heading" className="text-3xl font-semibold text-gray-800 text-center pt-3 pb-4">
