      ...
      <div className="flex flex-col items-center justify-center">
        <div className="w-full py-6 px-8 flex justify-center align-top flex-col items-center mt-16 mb-16">
          <div className="w-4/5 mb-16">
            ...
            <div className="w-full py-4 px-4 bg-white border-r border-l border-b border-gray-700 rounded-b-xl flex items-center">
              <img src="https://i.ibb.co/tBCp0hW/ic-round-thumb-up-alt.png" alt="ic-round-thumb-up-alt" border="0" className="w-44 h-44 rounded-xl justify-start mr-2"/>
              <div className="ml-2">
                <p className="font-semibold text-3xl text-gray-900 pb-3">Looking good, {firstName}{' '}</p>
                <p className="font-medium text-lg text-[#4F4F4F] pb-3">Make any edit you want, then submit your profile. you can make more changes after it is live</p>
                <button 
                  role="button" 
