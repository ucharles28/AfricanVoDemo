...
const TransRange = ({ nextStep, setTalentType }) => {

    const [isMenuOpen, setIsMenuOpen] = useState(false);
    const [show1, setShow1] = useState(false)

    const [error, setError] = useState(false);
    const [voiceOverButttonActive, setVoiceOverButttonActive] = useState('');
    const [translatorButttonActive, setTranslatorButttonActive] = useState('active');
    ...
    // add extra field for translator voice range
